...
export default function EditProjectForm({
    ...
    return (
        <form action={action} className="space-y-4">
            ...
            <input type="hidden" name="committeeId" value={project.committeeId || ''} />
            ...
            {state?.success && (
                <div className="p-3 bg-emerald-50 text-emerald-600 rounded-lg text-sm border border-emerald-100 mb-4">
